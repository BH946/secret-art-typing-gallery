...
* 4096x2304 비율에서 웹 엉망이 됨. 기존에는 1920 화면 기준으로 만들었어서 발생한 문제
* 따로 해상도별로 디자인을 준게 아니기 때문에 다시 비율로 크기 변경해서 해결하겠음
* 버그 -> container와 flex 같이쓰지말자 , ,
